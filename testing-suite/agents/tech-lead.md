...
1. **Analyze Tech Stack & Versions** — Do NOT assume versions. Read the root `package.json` and any project-specific settings (e.g. `project-checkpoints.md`, `CLAUDE.md`, `AGENTS.md`, `.omp/rules/tech-stack.md`) to discover the exact versions of the framework, runtime, and ORM in use.
